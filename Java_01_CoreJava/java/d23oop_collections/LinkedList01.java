...
public class LinkedList01 {
    public static void main(String[] args) {
        ...
        İç içe geçmiş array'ler karmaşıktır: Bu, array'lerin birbirleriyle ilişkili olduğu
        durumlarda karmaşık ve hata yapmaya müsaittir.
        Array'ler genel olarak verimli değildir: Bu, ekleme, silme ve arama gibi işlemler
         için genellikle daha yavaştır.
        ...
        */
        ...
        System.out.println(linkedList2); //[Eleman1, Eleman2, Eleman3], modern bir yol

        List<String> immutableList = List.of("Eleman1", "Eleman2", "Eleman3"); //degismez boyuta sahip oldu
        //immutableList.add("serkan"); HATA
        ...
        //Listedeki tum Yusuf'lari silelim
