...
public class Operators {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(amountOfMoney1 / numberOfPeople1); //2, 2.5 cikmaliydi. Java 0.5'i sildi
        ...
        /*3) Comparison (Karsilastirma) Operators
           <, >, <=, >=, ==, !=
           Not: Karsilastirma operatorlerini kullandiginizda sonuc kesinlikle
           boolean (true, false) alirsiniz*/
