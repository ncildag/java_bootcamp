...
public class Lambda01 {
    ...
    //----------------------------
    //Örnek 1) Bir list'teki elemanlari ayni satirda aralarina bosluk koyarak
    // yazdiran method'u olusturunuz.(Structured == Yapisal)
    //Example 1) List elements on the same line with a space between them create the method that writes
    ...
    //----------------------------
    //Örnek 2) Bir list'teki elemanlari ayni satirda aralarina bosluk koyarak
    //   yazdiran method'u olusturunuz.(Functional)
    //Example 2) List elements in a list on the same line with a space between them
    ...
    public static void printElements2(List<Integer> nums) {
        ...
        nums.stream().forEach(t -> System.out.print(t + " ")); //t -> akistan gelen her bir eleman icin
