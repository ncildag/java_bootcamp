...
public class Lambda01 {
    ...
    //-----------------------
    //Örnek 3:Bir List<String> içinde karakter sayısı 5'ten fazla olan tüm elemanları
    // büyük harfe çevirip, bu elemanları yeni bir liste olarak döndüren bir metod yazınız.
    //Example 3:Write a method that converts all elements with more than 5 characters in
    // a List<String> to uppercase and returns these elements as a new list.
    ...
    //Comparator.comparing(): Comparator interface bulunan comparing metodu,
