...
public class DateTime01 {
    public static void main(String[] args) {
        ...
        LocalDate myDate = LocalDate.now(); //now() metodu class ismiyle cagirildigi icin static metottur
        System.out.println(myDate); //2025-05-07
        ...
        //Degisme ihtimali olmayan datalari depolamak icin kullanilir.
        // Haftanin gun isimleri, Ay isimleri gibi
        ...
        System.out.println(myDate.getDayOfYear()); //127, yilin 127.gunu
        ...
        System.out.println(day2); //WEDNESDAY , ENUM yapisi
        ...
        System.out.println(newDate); //2026-07-11
