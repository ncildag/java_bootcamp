...
public class Car {
    ...
    /*
        ...
        b- Parametreli
     */
    //------------------//1- custom constructor - parametreli
    public Car(String brand, String model, int year, boolean hybrid) {

        this.brand = brand; //Bu classtaki brand kullanilmayacak, parametre olarak disardan gonderilecek
        this.model = model;
        this.year = year;
        this.hybrid = hybrid;
    ...
    //------------------//2- custom constructor - parametreli
    public Car (String brand, String model) {
        this.brand = brand;
        this.model = model;
    }

    //------------------//3- custom constructor - parametreli
