...
public class ForLoops02 {
    public static void main(String[] args) {
        ...
        //break keyword’u, bir döngüyü veya bir switch ifadesini
        // erken bir şekilde sonlandırmak için kullanılır.
        ...
        for (int i = 0; i < s1.length(); i++) {
            ...
            if (ch >= 'a' && ch <= 'z') {
                continue; //Artirma/azaltmaya goturur, islem yapma Artirma/azaltmaya git
            } else {
        ...
        String t = "Java";
        String reverse = "";  // ters cevrileni bunun icinde saklayacagiz

        for (int i = t.length() - 1; i >= 0; i--) {

            reverse = reverse + t.charAt(i);
            //reverse = reverse + t.substring(i, i +1); de calisir
