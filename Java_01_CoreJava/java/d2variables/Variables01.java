...
public class Variables01 {
    ...
    public static void main(String[] args){
        ...
        byte studentAge = 25;
        System.out.println(studentAge); //25
        ...
        int countryPopulation = 84123456;
        System.out.println("Ulke Nufusu : " + countryPopulation); //Ulke Nufusu : 84123456
        System.out.println("countryPopulation = " + countryPopulation); //countryPopulation = 84123456
