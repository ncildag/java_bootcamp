...
public class Arrays01 {
    public static void main(String[] args) {
        ...
        */
        ...
        for (int i = 0; i < cities.length; i++) { //Buradaki length field'dir, Array'e direkt uygulanir
            totalChar = totalChar + cities[i].length(); //Buradaki length() method'dur, String'e uygulanir
        }
        System.out.println(totalChar); //30

        //------------------
        //2.yol: for each loop -enhanced loop - gelistirilmis loop
