...
public class Sb01 {
    public static void main(String[] args) {
        ...
        Siz eger verilen bu capacity’i asarsaniz Java yeni capacity’i var olanin 2 katinin
        2 fazlasi olacak sekilde ayarlar
        ...
        //ODEV: Ayri append()'le eklense 44 mu olur 70'mi?
        System.out.println(sb4.length()); //24 //44
        System.out.println(sb4.capacity()); //34 //44 , 32 yi asinca Java length() kadar acti
