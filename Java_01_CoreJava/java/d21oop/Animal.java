...
public class Animal {
    ...
    */
    ...
    /*c) Ama coklu parent’lardan yararlanamamak iyi olmadi. Ozelliklerini inherit etmek istedigimiz
     class’lar birden fazla ise (parent’lar) o durumda Java bize, Apartman tarzi yapilanma
     olusturmustur.('Multi Level Inheritance’) Java bunu kabul eder.*/
    ...
    //----------------------
    //Parent’ta int veri turunde bir method
    // acip, child’da override etseydik ne olurdu?
    //primitive'ler arasinda, class olmadiklarindan parent-child iliskisi yoktur

    //----------------------
    //Peki Parent’ta Class veri turunde bir
    // method acip, child’da override etseydik ne olurdu?
    //Parent'taki return type her zaman ust class olmalidir
    ...
    1- Java’da "final" anahtar kelimesi (keyword) ile işaretlenen bir method,
    child class’lar tarafından override edilemez.
    2- Yani, bir class’in child’lari, final olarak işaretlenmiş bir methodu değiştiremez
    ...
    Sonuc: "Final" kelimesi, programcılara kodlarını daha güvenli ve öngörülebilir hale getirme,
    optimizasyon sağlama
    veya belirli davranışları zorlamada yardımcı olmak için kullanılır.*/

    public void eat() {
        System.out.println("Animals eat...");
        final double pi = 3.14;
        //pi = 4; HATA, pi degistirilemez
    }
