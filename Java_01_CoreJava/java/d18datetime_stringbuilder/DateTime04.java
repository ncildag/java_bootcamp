...
public class    DateTime04 {
    public static void main(String[] args) {
        ...
        System.out.println(dateInTokyo); //2025-05-09

        //---------
        //Amsterdam'da ayin kaci?

        LocalDate dateInAmsterdam = LocalDate.now(ZoneId.of("Europe/Amsterdam"));
        System.out.println(dateInAmsterdam); //2025-05-08

        //---------
        //Tokyo'da saat kac?

        LocalTime timeInTokyo = LocalTime.now(ZoneId.of("Asia/Tokyo"));
        System.out.println(timeInTokyo); //04:11:15.368376
...
//        System.out.println("Toplam zaman dilimi sayisi : " + zoneIds.size());
        ...
        System.out.println(ldt); //2025-05-08T22:24:25.999052
