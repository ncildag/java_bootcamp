...
public class DateTime01 {
    public static void main(String[] args) {
        ...
        //Example 1: If the date you have received from the user is in the past, give the message
        ...
        LocalDate givenDate = null; //LocalDate givenDate; seklinde de yazabilirdik
        ...
        while (true) {
            ...
            if (givenDate.isBefore(LocalDate.now())) {
                ...
                break; //Gecerli tarih girildi, donguden cikalim
            }
