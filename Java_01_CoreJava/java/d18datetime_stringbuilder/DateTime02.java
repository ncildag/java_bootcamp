...
public class DateTime02 {
    public static void main(String[] args) {
        ...
        //example 1: Write the code that takes the date of birth from the user and
        // finds the day name of the date entered.
        ...
        System.out.println(date.getDayOfWeek()); //Girilen tarihin gununu alir
